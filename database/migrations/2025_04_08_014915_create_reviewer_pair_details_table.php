...
return new class extends Migration
{
    ...
    {
        Schema::create('reviewer_pair_details', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('reviewer_pair_id')->comment('ID cap giam khao');
            $table->unsignedBigInteger('reviewer_id')->comment('ID giam khao');
            $table->unsignedTinyInteger('reviewer_role')->default(1)->comment('Vai tro giam khao');
    ...
    {
        Schema::dropIfExists('reviewer_pair_details');
    }
};
